...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    switch ($action) {
        ...
        case 'edit':
            ...
            $stmt = $conn->prepare("UPDATE faculty SET first_name = ?, last_name = ?, email = ?, phone = ?, address = ?, department = ?, designation = ?, specialization = ?, status = ? WHERE id = ?");
            $stmt->bind_param("sssssssssi", $first_name, $last_name, $email, $phone, $address, $department, $designation, $specialization, $status, $id);
            
            if ($stmt->execute()) {
                $success = "Faculty updated successfully!";
            } else {
                $error = "Error updating faculty: " . $conn->error;
            }
            $stmt->close();
            break;
...
<head>
    ...
    <title>Manage Faculty - CIMAGE LMS</title>
...
<body>
        ...
        <div class="main-content">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <span>Total: <?php echo $faculty->num_rows; ?></span>
                </div>
                <div class="card-body">
                    <table class="table">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge <?php 
                                        echo $member['status'] == 'active' ? 'badge-success' : 'badge-warning'; 
                                    ?>">
                                ...
                                <td>
                                    <div class="actions">
                                        <button class="btn btn-warning btn-sm" onclick="openEditModal(<?php echo $member['id']; ?>)">
    ...
    <div id="addModal" class="modal">
        <div class="modal-content">
            ...
            <form method="POST" onsubmit="return validateFacultyForm(this)">
                <input type="hidden" name="action" value="add">
                <div class="form-row">
                    <div class="form-group">
                        <label>Faculty ID</label>
                        <input type="text" name="faculty_id" required pattern="[0-9]+" title="Faculty ID must contain only numbers">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="specialization" placeholder="e.g., Web Development, Database Management">
                </div>
                <div class="form-group">
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            ...
            <form method="POST" id="editForm" onsubmit="return validateFacultyForm(this)">
    ...
    <script>
        function validateFacultyForm(form) {
            ...
            const facultyId = form.querySelector('[name="faculty_id"]');
            if (facultyId && !/^[0-9]+$/.test(facultyId.value)) {
                alert('Faculty ID must contain only numbers');
                facultyId.focus();
                return false;
            }
        ...
        function openEditModal(id) {
            // Fetch faculty data and populate form
